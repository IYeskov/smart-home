...
import { Tv, ViewTv } from "../Devices/Tv";
import { Bulb, ViewBulb } from "../Devices/Bulb";
import { Conditioner, ViewConditioner } from "../Devices/Conditioner";
  ...
  render() {
    ...
    if (this._home === null) {
      ...
      btnShowDevices.addEventListener("click", () => {
        ...
        console.log(this._home.inactiveDevices);
      });
